...
def predict(data: InputData):
    ...
    try:
        ...
        model_path = 'taxinycsoyhenry/xgb_model.pkl'
...
def top_3_vehicles(max_price_usd: float):
    ...
    try:    
        ...
        s3_path = 'taxinycsoyhenry/vehicles_info.parquet'
...
def taxi_stats_test(pickup_borough: str):
    ...
    try:
        ...
        conn = connect(aws_access_key_id=aws_access_key_id,
                    ...
                    schema_name='nyctaxis_db',
                    s3_staging_dir='s3://bucketaxisgabriel/')

        # Ejecutamos una consulta
        query = '''
            WITH bucketaxisgabriel AS (
        SELECT
            "pickup_borough",
